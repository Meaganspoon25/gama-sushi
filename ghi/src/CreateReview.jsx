...
function CreateReview() {
    const [formData, setFormData] = useState({
        review: '',
        recommendation: false, // Default value for boolean
        date_submitted: new Date().toISOString(), // Default value for datetime
        rating: '',
    });
                ...
                <div className="shadow p-4 mt-4">
                    ...
                    <form onSubmit={handleSubmit} id="create-review-form">
                        ...
                        <div className="form-check mb-3">
                            ...
                            />
                            <label htmlFor="recommendation" className="form-check-label">Recommendation</label>
                        </div>
