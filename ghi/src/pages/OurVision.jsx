                ...
                <div className="container">
                    ...
                    <div className="col-12 mt-4 mb-4">
                        <h3 className="text-center fs-1 text">
                            ...
                            elit. Quia facilis neque culpa alias impedit,
                            deleniti blanditiis facere itaque! Dignissimos
                            rerum, molestias quis corporis a repudiandae? Vitae
                            nobis nisi pariatur doloribus.
                        </h3>
                    </div>
                </div>
            </div>
